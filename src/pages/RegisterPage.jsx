...
//       role: String(selectedRole || "student").toUpperCase(), // STUDENT / INSTRUCTOR
//     };

//     const res = await authAPI.register(payload);
//     // If you want to auto-login, you already get a token in the response
...
import { Link, useNavigate } from "react-router-dom";
import { useForm } from "react-hook-form";
import { Eye, EyeOff, BookOpen as BookOpenIcon, User } from "lucide-react";
import { toast } from "react-hot-toast";
...
const RegisterPage = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      const payload = {
        fullName: data.fullName, // backend expects 'fullName'
        email: data.email,
        password: data.password,
        role: String(selectedRole || "student").toUpperCase(), // STUDENT / INSTRUCTOR
      };
